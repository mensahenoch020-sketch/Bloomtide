...
Bloomtide now uses a Node/Express backend with Railway Postgres. The public appraisal form, Careers page and Admin dashboard all use the same API and database.
